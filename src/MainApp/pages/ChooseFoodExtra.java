...
foodimage Coffee1=new foodimage(ClassLoader.getSystemResource("MainApp/pages/image/coffee1.png"));
Coffee1.set1();
this.add(panel1,Integer.valueOf(2));
this.add(Coffee1,Integer.valueOf(4));
JPanel panel2=this.paintRect(270,200,1);
foodimage Cola2=new foodimage(ClassLoader.getSystemResource("MainApp/pages/image/cola2.png"));
Cola2.set2();
this.add(panel2,Integer.valueOf(2));
this.add(Cola2,Integer.valueOf(4));
JPanel panel3=this.paintRect(495,200,1);
foodimage Beer3=new foodimage(ClassLoader.getSystemResource("MainApp/pages/image/beer3.png"));
Beer3.set3();
this.add(panel3,Integer.valueOf(2));
this.add(Beer3,Integer.valueOf(4));
JPanel panel4=this.paintRect(720,200,1);
foodimage Juice4=new foodimage(ClassLoader.getSystemResource("MainApp/pages/image/juice4.png"));
Juice4.set4();
this.add(panel4,Integer.valueOf(2));
this.add(Juice4,Integer.valueOf(4));
JPanel panel5=this.paintRect(45,345,1);
foodimage WM5=new foodimage(ClassLoader.getSystemResource("MainApp/pages/image/WM5.png"));
WM5.set5();
this.add(panel5,Integer.valueOf(2));
this.add(WM5,Integer.valueOf(4));
JPanel panel6=this.paintRect(270,345,1);
foodimage Apple6=new foodimage(ClassLoader.getSystemResource("MainApp/pages/image/apple6.png"));
Apple6.set6();
this.add(panel6,Integer.valueOf(2));
this.add(Apple6,Integer.valueOf(4));
JPanel panel7=this.paintRect(495,345,1);
foodimage Hotdog7=new foodimage(ClassLoader.getSystemResource("MainApp/pages/image/hotdog7.png"));
this.add(panel7,Integer.valueOf(2));
this.add(Hotdog7,Integer.valueOf(4));
Hotdog7.set7();
JPanel panel8=this.paintRect(720,345,1);
foodimage French8=new foodimage(ClassLoader.getSystemResource("MainApp/pages/image/French fries8.png"));
French8.set8();
