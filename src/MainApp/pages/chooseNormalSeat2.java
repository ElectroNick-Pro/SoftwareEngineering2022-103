...
public class chooseNormalSeat2 {
    public int width = 960;
    public int height = 540;

    public chooseNormalSeat2(){
        /**
        ...
        */
        ...
        serviceIcon.changeIconSize("src/MainApp/pages/service.png", service, 40, 40);
    ...
    public static void main(String[] args) {
        chooseNormalSeat2 seat = new chooseNormalSeat2();
    }
}
