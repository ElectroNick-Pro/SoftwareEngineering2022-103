...
foodimage Dou1=new foodimage(ClassLoader.getSystemResource("MainApp/pages/image/doughnut1.png"));
Dou1.set1();
this.add(panel1,Integer.valueOf(2));
this.add(Dou1,Integer.valueOf(4));
JPanel panel2=this.paintRect(270,200,1);
foodimage Bread2=new foodimage(ClassLoader.getSystemResource("MainApp/pages/image/bread2.png"));
Bread2.set2();
this.add(panel2,Integer.valueOf(2));
this.add(Bread2,Integer.valueOf(4));
JPanel panel3=this.paintRect(495,200,1);
foodimage Choco3=new foodimage(ClassLoader.getSystemResource("MainApp/pages/image/chocolate3.png"));
Choco3.set3();
this.add(panel3,Integer.valueOf(2));
this.add(Choco3,Integer.valueOf(4));
JPanel panel4=this.paintRect(720,200,1);
foodimage Bis4=new foodimage(ClassLoader.getSystemResource("MainApp/pages/image/biscuit4.png"));
Bis4.set4();
this.add(panel4,Integer.valueOf(2));
this.add(Bis4,Integer.valueOf(4));
JPanel panel5=this.paintRect(45,345,1);
foodimage Pud5=new foodimage(ClassLoader.getSystemResource("MainApp/pages/image/pudding5.png"));
Pud5.set5();
this.add(panel5,Integer.valueOf(2));
this.add(Pud5,Integer.valueOf(4));
JPanel panel6=this.paintRect(270,345,1);
foodimage Lolli6=new foodimage(ClassLoader.getSystemResource("MainApp/pages/image/lollipop6.png"));
Lolli6.set6();
this.add(panel6,Integer.valueOf(2));
this.add(Lolli6,Integer.valueOf(4));
JPanel panel7=this.paintRect(495,345,1);
foodimage Rice7=new foodimage(ClassLoader.getSystemResource("MainApp/pages/image/rice ball7.png"));
this.add(panel7,Integer.valueOf(2));
this.add(Rice7,Integer.valueOf(4));
Rice7.set7();
JPanel panel8=this.paintRect(720,345,1);
foodimage Sushi8=new foodimage(ClassLoader.getSystemResource("MainApp/pages/image/sushi8.png"));
Sushi8.set8();
