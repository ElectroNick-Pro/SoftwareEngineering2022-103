...
public class confirmPay extends JFrame {
    ...
    public confirmPay() {
        ...
        next1.setText("credit card");
         next1.setBackground(new Color(0, 131, 255));
         next1.setForeground(Color.white);
         next1.setBounds(650, 460, 100, 35);
         next1.setFont(new Font("Microsoft YaHei UI", Font.BOLD, 14));
         next1.setBorder(new RoundBorder(new Color(30, 144, 255)));
         next1.setContentAreaFilled(true);
    
        JButton next2 = new JButton();
        next2.setText("QRcode");
        next2.setBackground(new Color(0, 131, 255));
        next2.setForeground(Color.white);
        next2.setBounds(800, 460, 100, 35);
        next2.setFont(new Font("Microsoft YaHei UI", Font.BOLD, 14));
        next2.setBorder(new RoundBorder(new Color(30, 144, 255)));
        next2.setContentAreaFilled(true);
